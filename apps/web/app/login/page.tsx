...
import { Workflow, Mail, Lock, ArrowRight, Loader2, ShieldCheck } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mfaRequired) {
        const response = await apiClient.post('/auth/login-2fa', { userId: mfaUserId, token: mfaToken });
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        autoFocus
                        maxLength={6}
                        className="flex h-12 w-full rounded-md border border-slate-200 bg-white px-10 py-2 text-2xl tracking-[0.5em] font-mono text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                        placeholder="000000"
                        value={mfaToken}
